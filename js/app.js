...
function arrowCheck(){
	if(x===1){
		...
		document.getElementById('dot1').style.background = "#D478B5";
		...
		document.getElementById('dot2').style.background = "#D478B5";
		document.getElementById('dot3').style.background = "white";
	} else if(x===3) {
		...
		document.getElementById('dot1').style.background = "white";
		document.getElementById('dot2').style.background = "white";
		document.getElementById('dot3').style.background = "#D478B5";
	}
}
